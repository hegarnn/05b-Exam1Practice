...
def problem2b(rect, n, delta, win):
    ...
    rect2 = rg.Rectangle(rect.get_upper_left_corner(),rect.get_lower_right_corner())
    rect2.attach_to(win)

    for _ in range(n):

        rect2 = rg.Rectangle(rg.Point(rect2.corner_1.x - delta, rect2.corner_1.y - delta),rg.Point(rect2.corner_2.x + delta, rect2.corner_2.y + delta))
